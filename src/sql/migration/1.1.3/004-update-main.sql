## Update WIG and Predictive SPs to save logs ## 
USE `${DB_MAIN}`;
...
BEGIN
    ...
    SET varUserId = (SELECT CreatedBy FROM WIG WHERE Id=pWIGId);
    ## EventType - TeamId - WIGId - PredictiveId - TrackingId -Tracking WIG - Tracking Predictive - CommitmentId - CommitmentTrackingId - CreatedBy ##
    CALL Log_Save (3, null, pWIGId, null, null, null, null, null, null, varUserId);
...
BEGIN
    ...
    IF varPredictives < 3 THEN 
        ...
        ## EventType - TeamId - WIGId - PredictiveId - TrackingId -Tracking WIG - Tracking Predictive - CommitmentId - CommitmentTrackingId - CreatedBy ##
        CALL Log_Save (1, null, null, varPredictiveId, null, null, null, null, null, pUserId);
    ELSE
...
BEGIN
    ...
    SET varUserId = (SELECT CreatedBy FROM Predictive WHERE Id=pPredictiveId);
    ## EventType - TeamId - WIGId - PredictiveId - TrackingId -Tracking WIG - Tracking Predictive - CommitmentId - CommitmentTrackingId - CreatedBy ##
    CALL Log_Save (2, null, null, pPredictiveId, null, null, null, null, null, varUserId);
...
BEGIN
    ...
    SET varUserId = (SELECT CreatedBy FROM Predictive WHERE Id=pPredictiveId);
    ## EventType - TeamId - WIGId - PredictiveId - TrackingId -Tracking WIG - Tracking Predictive - CommitmentId - CommitmentTrackingId - CreatedBy ##
    CALL Log_Save (3, null, null, pPredictiveId, null, null, null, null, null, varUserId);
